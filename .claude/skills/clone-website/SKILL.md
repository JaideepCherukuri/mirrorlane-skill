---
name: clone-website
description: Use Mirrorlane CLI artifacts to rebuild public websites as componentized production-grade Next.js/Tailwind projects with high visual parity. Trigger when asked to clone, recreate, mirror, rebuild, or pixel-match a website using Mirrorlane, a clean capture ZIP, or a Mirrorlane reference package.
---
